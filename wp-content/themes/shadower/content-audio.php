...
$audio             = shadower_get_content_audio();
?>
...
<?php } else { ?>
    ...
    <!-- Topics Item -->
    <div <?php post_class( array( 'topics-item', 'style-1', 'scroll-reveal', ( ( empty( $audio ) ) ? esc_attr( 'no-featured-img' ) : '' ) ) ); ?> id="post-<?php the_ID(); ?>">
        <div class="row">
                ...
                <?php if ( ! empty( $audio ) ) { ?>
                    <div class="col-sm-6 topics-item-img transition">
                         <?php echo shadower_wp_kses( $audio ); ?>
                    </div>
