...
$video             = shadower_get_content_video();
?>
...
<?php } else { ?>
    ...
    <!-- Topics Item -->
    <div <?php post_class( array( 'topics-item', 'style-1', 'scroll-reveal', ( ( empty( $video ) ) ? esc_attr( 'no-featured-img' ) : '' ) ) ); ?> id="post-<?php the_ID(); ?>">
        <div class="row">
                ...
                <?php if ( ! empty( $video ) ) { ?>
                    <div class="col-sm-6 topics-item-img transition">
						 <div class="embed-responsive embed-responsive-16by9">
							<?php  echo shadower_wp_kses( $video ); ?>
						 </div>
                    </div>
