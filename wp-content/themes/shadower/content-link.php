...
$link              = shadower_get_content_linkurl();
?>
            ...
            <div class="pos-vertical-align t-c">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                            ...
                            <h3><a href="<?php echo esc_url( $link ); ?>" target="_blank"><i class="fa fa-external-link"></i></a></h3>
                    </div>
                </div>
                <!-- .row end -->
    ...
    <div <?php post_class( array( 'topics-item', 'style-1', 'scroll-reveal', ( ( !has_post_thumbnail() ) ? esc_attr( 'no-featured-img' ) : '' ) ) ); ?> id="post-<?php the_ID(); ?>">
        <div class="row">
                ...
                <div class="title-style-fieldset">
                     <?php the_title( sprintf( '<h4><a href="%s" target="_blank">', esc_url( $link ) ), '</a></h4>' ); ?>
                    ...
                    <div class="col-md-6 topics-item-info list-normal table-normal">
                          <?php
								if ( empty( $link ) ) {
									...
									echo str_replace( $link, '', get_the_excerpt() );
								}	   
					      ?>
                    </div>
